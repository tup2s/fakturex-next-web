...
WSGI_APPLICATION = 'fakturex.wsgi.application'
...
# Password validation defined at the bottom of settings
...
if not DEBUG:
    ...
    # Clickjacking Protection (already in middleware but explicit)
